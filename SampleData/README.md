The sample datasets in this folder are used during this workshop. The datasets are a simple fictitious customer dataset around telecom churn (cancelling service).
